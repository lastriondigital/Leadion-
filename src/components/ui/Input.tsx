    ...
    <div className="w-full flex flex-col gap-1.5">
      ...
      <div className="relative flex items-center w-full">
        ...
        <input
          ...
          } rounded-[11px] min-h-[48px] py-3 px-3.5 sm:min-h-[44px] sm:py-2.5 transition-all duration-150 outline-none focus:ring-3 ${
            icon ? 'pl-10' : ''
          } ${iconRight ? 'pr-10' : ''} disabled:bg-zinc-50 disabled:text-zinc-400 disabled:cursor-not-allowed ${className}`}
          {...props}
        />
        {iconRight && (
